...
bool CollisionSystem::Collides(Position t1, PolygonCollider p1, Rotatable rot1, Position t2, 
                               PolygonCollider p2, Rotatable rot2)
{
...
{
    auto movables = registry.view<Position, PolygonCollider, Rotatable, RigidBody>();
